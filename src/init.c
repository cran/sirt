...
extern SEXP sirt_xxirt_compute_likelihood_helper(SEXP, SEXP, SEXP, SEXP, SEXP);
extern SEXP sirt_xxirt_compute_posterior_expected_counts(SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"sirt_xxirt_compute_likelihood_helper",         (DL_FUNC) &sirt_xxirt_compute_likelihood_helper,          5},
    {"sirt_xxirt_compute_posterior_expected_counts", (DL_FUNC) &sirt_xxirt_compute_posterior_expected_counts,  2},
    {NULL, NULL, 0}
};
