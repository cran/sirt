...
RcppExport SEXP sirt_xxirt_compute_posterior_expected_counts(SEXP dat1_resp_ggSEXP, SEXP p_aj_xi_ggSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    __result = Rcpp::wrap(xxirt_compute_posterior_expected_counts(dat1_resp_gg, p_aj_xi_gg));
    return __result;
END_RCPP
}
...
RcppExport SEXP sirt_xxirt_compute_likelihood_helper(SEXP datSEXP, SEXP dat_respSEXP, SEXP probsSEXP, SEXP TPSEXP, SEXP maxKSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    Rcpp::traits::input_parameter< int >::type TP(TPSEXP);
    Rcpp::traits::input_parameter< int >::type maxK(maxKSEXP);
    __result = Rcpp::wrap(xxirt_compute_likelihood_helper(dat, dat_resp, probs, TP, maxK));
    return __result;
END_RCPP
}
