        ...
        b0.jk, b1.jk, b2.jk, b3.jk, pm, wgtm, use_rcpp=FALSE )
{
    ...
    if (use_rcpp){
        ...
        res <- sirt_rcpp_noharm_sirt_optim_gr_rcpp( gamma_val=gamma_val, NH=NH,
                    I=I, wgtm=wgtm, pm=pm, b0_jk=b0.jk, b1_jk=b1.jk, b2_jk=b2.jk, b3_jk=b3.jk, npar=npar,
                    pt_matid=pt_matid, pt_index=pt_index, pt_row=pt_row,
                    pt_col=pt_col, FP=FP, Fmat=Fmat, Pmat=Pmat, Psimat=Psimat )
        grad0 <- res$grad0
    } else {
        grad0 <- noharm_sirt_optim_gradient_R( parm_table_free=parm_table_free,
                    Fmat=Fmat, Pmat=Pmat, Psimat=Psimat, FP=FP, npar=npar, NH=NH, I=I,
                    gamma_val=gamma_val, pm=pm, wgtm=wgtm, b0.jk=b0.jk, b1.jk=b1.jk, b2.jk=b2.jk,
                    b3.jk=b3.jk )
    }
