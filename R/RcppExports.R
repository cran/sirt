...
## File Version: 0.16
## File Last Change: 2017-09-19 21:06:02
...
xxirt_compute_posterior_expected_counts <- function(dat1_resp_gg, p_aj_xi_gg) {
    .Call('_sirt_xxirt_compute_posterior_expected_counts', PACKAGE = 'sirt', dat1_resp_gg, p_aj_xi_gg)
}

xxirt_compute_likelihood_helper <- function(dat, dat_resp, probs, TP, maxK) {
    .Call('_sirt_xxirt_compute_likelihood_helper', PACKAGE = 'sirt', dat, dat_resp, probs, TP, maxK)
}
