...
sirt_rcpp_noharm_estF <- function(Fval, Pval, Fpatt, Ppatt, I, D, b0jk, b1jk, b2jk, b3jk, wgtm, pm, Psival, Psipatt, maxincrement, modtype) {
    .Call('_sirt_sirt_rcpp_noharm_estF', PACKAGE='sirt', Fval, Pval, Fpatt, Ppatt, I, D, b0jk, b1jk, b2jk, b3jk, wgtm, pm, Psival, Psipatt, maxincrement, modtype)
}

sirt_rcpp_noharm_estP <- function(Fval, Pval, Fpatt, Ppatt, I, D, b0jk, b1jk, b2jk, b3jk, wgtm, pm, Psival, Psipatt, maxincrement, modtype) {
    .Call('_sirt_sirt_rcpp_noharm_estP', PACKAGE='sirt', Fval, Pval, Fpatt, Ppatt, I, D, b0jk, b1jk, b2jk, b3jk, wgtm, pm, Psival, Psipatt, maxincrement, modtype)
}

sirt_rcpp_noharm_estPsi <- function(Fval, Pval, Fpatt, Ppatt, I, D, b0jk, b1jk, b2jk, b3jk, wgtm, pm, Psival, Psipatt, maxincrement, modtype) {
    .Call('_sirt_sirt_rcpp_noharm_estPsi', PACKAGE='sirt', Fval, Pval, Fpatt, Ppatt, I, D, b0jk, b1jk, b2jk, b3jk, wgtm, pm, Psival, Psipatt, maxincrement, modtype)
}
